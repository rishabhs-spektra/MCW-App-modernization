...
2. From the **Application gateways (1)** section, click on **Create (2)** and select **Application Gateway (3)** from the dropdown.
...
9. Under **Add a backend pool** page, enter the details below:
...
12. Now, on the **Add a routing rule** page, enter the details below:
...
6. Under **Add a rule collection** page, enter the details below:
   ...
   - Under **Rules (5)** mention the below details:
     ...
     - Destination: Enter the IP address of the **Firewall** that you copied in task 1
