...
1. Connect to your on-premises SQL Database by clicking **Connect (3)** in the Object Explorer.

   ![](media/Sql-server-connect.png)
   
    >**Note:** If you encounter a server certificate error, make sure you have set **encryption as Optional (1)** and **checked** the **trust server certificate box (2)**.
