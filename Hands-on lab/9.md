...
6. On the **Access Configuration** tab of the key vault, select the **Vault Access Policy (1)** in Permission Model and select the **ODL_USER_<inject key="DeploymentID"/> (2)** in Access Policies.
...
8. Under the **Principal** tab, enter the **system-assigned managed identity (1)** you copied previously in step 4 and select it **(2)**. Click on **Next (3)**.
