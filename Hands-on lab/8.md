...
8. On the **Overview** page, select **Create** for **Create by adding HTTP requests** given under _Load test your application and infrastructure_.
...
9. On the Quick test page, provide the following details:
   ...
   - The rest of the details are optional. The default values are already updated for all the tasks.
