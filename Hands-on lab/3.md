...
6. We have just completed the migration of the Parts Unlimited website from IIS into a Virtual Machine to Azure App Service. Congratulations. Let's go back to the Azure Portal and look into Azure Migrate. Search for `Azure migrate` **(1)** on the Azure Portal and select **Azure Migrate (2)**.*.
