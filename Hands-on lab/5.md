...
2. Create a Personal Access Token as described below.
 ...
 4. In the upper-right corner of your GitHub page, select your profile photo, then click **Your Repositories** and select the **New** button positioned on the top of the repositories list. As an alternative, you can [navigate to the new repository site here](https://github.com/new).
