...
1. Browse to `https://github.com` in your browser and log in to your account using your own GitHub credentials.
...
15. The GitHub authentication screen will pop up. Provide a **Personal Access Token** that you noted earlier and click on **Sign in**.
...
9. On the workflow editor screen, provide the file name **stagingdeploy.yml**. Commit your changes by selecting the **Commit Changes** button twice.
...
12. Open the newly updated stagingdeploy.yml file in Visual Studio Code. Replace the suffix value on lines 7 and 11 with **<inject key="DeploymentID" />** to match your lab. Save the file by pressing **CTRL+S**.
...
15. Once the workflow is completed go back to your lab resource group on the Azure Portal, and navigate to your `staging (partsunlimited-web-/staging)` **(2)** App Service resource. You can search for `staging` **(1)** to find your App Service (Slot) for staging.
