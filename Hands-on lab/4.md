...
1. Navigate back to the RDP VM. Return to the Data Migration Assistant, and select the New **(+)** icon in the left-hand menu.
...
1. Start typing **sql server management** **(1)** into the search bar, then select **SQL Server Management Studio 18 (2)** in the search results.
